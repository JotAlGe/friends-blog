            ...
            <div class="col-12 grid-margin">
                <div class="profile-header">
                    <div class="cover">
                        ...
                        <figure>
                            {{-- profile photo --}}
                            @if ($user->cover_photo == 'portada.png')
                            <img src=" {{ asset('assets/images/'. $user->cover_photo) }} ">
                            @else
                            <img src="{{ $user->cover_photo }}" class="img-fluid" alt="profile cover">
                            @endif
                        ...
                        <div class="cover-body d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <img class="profile-pic" src="{{ asset('assets/images/user.png') }}" alt="profile">
                                @else

                                <img class="profile-pic" src="{{ $user->profile_photo }}" alt="profile">
                    ...
                    <div class="header-links">
                        <ul class="links d-flex align-items-center mt-3 mt-md-0">
                            <li class="header-link-item d-flex align-items-center active">
                                ...
                                <a class="pt-1px d-none d-md-block" href="{{route('home')}}">Inicio</a>
                            </li>
                ...
                <div class="card rounded">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            <h6 class="card-title mb-0"><label class="tx-11 font-weight-bold mb-0 text-uppercase">Sobre
                                    {{ $user->name }}:
                                </label>
                            </h6>
                            {{--  <div class="dropdown">
                        ...
                        @if ($user->birth != NULL)
                        <div class="mt-3">
                            <label class="tx-11 font-weight-bold mb-0 text-uppercase">Cumpleaños:</label>
                            <p class="text-muted">{{ $user->birth }}</p>
                        </div>
                        @endif

                        @if ($user->address->street->locality->province->description != null)
                        <div class="mt-3">
                            <label class="tx-11 font-weight-bold mb-0 text-uppercase">Vive en:</label>
                            <p class="text-muted">{{ $user->address->street->locality->description }}
                                , {{$user->address->street->locality->province->description}}
                            </p>
                        </div>
                        @endif
                        <div class="mt-3">
                            <label class="tx-11 font-weight-bold mb-0 text-uppercase">Correo:</label>
                            <p class="text-muted">{{ $user->email }}</p>
                        </div>
                        <div class="mt-3">
                            <label class="tx-11 font-weight-bold mb-0 text-uppercase">Nombre de usuario:</label>
                            <p class="text-muted">
                                {{ $user->username }}
                            </p>
                        </div>
                            ...
                            <div class="card-header">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        <img class="img-xs rounded-circle" src="{{ $user->profile_photo }}" alt="">
                                        <div class="ml-2">
            ...
            <div class="d-none d-xl-block col-xl-3 right-wrapper">
                <div class="row">
                    <div class="col-md-12 grid-margin">
                        <div class="card rounded">
                            <div class="card-body">
                                <h6 class="card-title">Fotos de {{ $user->name }}</h6>
                                <div class="latest-photos">
                                    <div class="row">

                                        {{-- photo gallery --}}
                                        @forelse ($user->posts as $photo)
